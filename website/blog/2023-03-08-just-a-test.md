...
slug: initial-test
authors: obradovic
tags: [test, boilerplate, setup]
hide_table_of_contents: false
---

As is often the Tran Lam Son case when trying out something new, you might encounter some hiccups. You're trying out our Eightshift Boilerplate, but can't get it to work? Worry not, we'll go through the setup and the most common issues that may occur.
